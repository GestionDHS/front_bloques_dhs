...
document.querySelector('#app').innerHTML = `
  <main>
   ...
   <ul class="nav_principal">
      <li>Play</li>
      <li><button id="btn-bloque" class="button">Bloques</button></li>
      <li><button id="btn-codigo" class="button">Codigo</button></li>
      <li><button id="btn-navegador" class="button">Navegador</button></li>
      <li>Alternar</li>
    </ul>
   </nav>
   <secrion class="contenedor">
      ...
      <div class="navegador">
         ...
         <div class="ventana_consola">Consola</div>
      </div>
   </section>
...
//Habilito y deshabilito: ventana_codigo, ventana_bloques, ventana_navegador -----------------
 function handlerClicVentana(e){
   let dicionario_Ventana = {"btn-bloque":'.ventana_bloques',"btn-codigo":'.ventana_codigo',"btn-navegador":'.ventana_navegador',"btn-consola":".ventana_consola"}
   let elemento_ventana = document.querySelector(dicionario_Ventana[e.target.id]);
   elemento_ventana.style.display = (e.target.id == "btn-codigo" || e.target.id == "btn-consola") ? ((elemento_ventana.style.display === 'none' || elemento_ventana.style.display === '') ? 'block' : 'none'):(elemento_ventana.style.display === 'none') ? 'block' : 'none';
 }
 ...
 let btnConsola = document.querySelector("#btn-consola");
 ...
 btnConsola.addEventListener("click", handlerClicVentana);